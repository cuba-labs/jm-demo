...
public class JmdemoTestContainer extends TestContainer {

    public JmdemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/jmdemo/app.properties",
    ...
    public static class Common extends JmdemoTestContainer {

        public static final JmdemoTestContainer.Common INSTANCE = new JmdemoTestContainer.Common();
